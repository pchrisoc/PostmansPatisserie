...
export default function Footer() {
  return (
    <footer className="bg-amber-50 text-amber-900 py-12 px-8 mt-auto border-t border-amber-200 relative overflow-hidden transition-all duration-300 hover:bg-amber-100">
